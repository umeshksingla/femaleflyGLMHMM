...
if __name__  == '__main__':
    ...
    model = idglmhmm_model_pkl['model']
    ...
    test_emissions = chance_shuffled_model_pkl['test_data']['test_emissions']
    test_shuffled_inputs = chance_shuffled_model_pkl['test_data']['test_inputs']

    train_shuffled_soft_emission_predictions, _, _, _, _ = model.predict(train_emissions, train_shuffled_inputs)
    test_shuffled_soft_emission_predictions, _, _, _, _ = model.predict(test_emissions, test_shuffled_inputs)

    shuffled_scores = {
        'train_shuffled_lp': model.get_data_logprob(train_emissions, train_shuffled_inputs),
        'train_shuffled_lp_by_fly': model.get_data_logprob_by_fly(train_emissions, train_shuffled_inputs),
        'train_shuffled_score': model.score(train_emissions, train_shuffled_soft_emission_predictions),
        'train_shuffled_pearson': model.pearson(train_emissions, train_shuffled_soft_emission_predictions),

        'test_shuffled_lp': model.get_data_logprob(test_emissions, test_shuffled_inputs),
        'test_shuffled_lp_by_fly': model.get_data_logprob_by_fly(test_emissions, test_shuffled_inputs),
        'test_shuffled_score': model.score(test_emissions, test_shuffled_soft_emission_predictions),
        'test_shuffled_pearson': model.pearson(test_emissions, test_shuffled_soft_emission_predictions),
    }
    print(shuffled_scores)
    joblib.dump(shuffled_scores, 'shuffled_scores.pkl')
