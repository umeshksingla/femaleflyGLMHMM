...
if __name__ == '__main__':
    dataset = 'wt'
    if dataset == 'wt':
        data_path = f'../data/wt_fly_data_cos=4_ortho_o=5_smoothed_stdset_auxem_1114.pkl'
        ...
        data_path = f'../data/wt_fred_fly_data_cos=4_ortho_o=5_smoothed_stdset_auxem_1114.pkl'
    else:
